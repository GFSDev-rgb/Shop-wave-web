...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn the story behind ShopWave, our mission to champion conscious consumerism, and our passion for quality craftsmanship.',
};
  ...
  return (
    <div className="bg-transparent flex-1">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="relative w-full h-96 rounded-lg overflow-hidden shadow-2xl mb-16 border">
            <Image 
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="bg-card/50 backdrop-blur-sm border p-8 rounded-lg space-y-4">
